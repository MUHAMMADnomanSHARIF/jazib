...
<div class="container py-5">
    <p class="col-sm-12">
       <span  class="col-sm-3"> <i class="fas fa-file-powerpoint"></i> All Products</span>
       <span class="col-sm-12"></span>
         <button  align="right" class="col-sm-2 btn btn-primary btn-sm" style="display: inline;" > Add Copun code</button>
   </p>
