        ...
        /* Email Alert Starts Here*/
         ...
         $Order_Details=$Orders->Order_Details;
            ...
            $status=$Orders->p_status;
        	                ...
        	                $emailbody='<p>Your Order has been Shipped. Your estimated delivery date is 3-5 working days. If you would like to view the status of your order or make any changes to it, please visit Your Orders on <a href="https://www.ouction.pk">Ouction.pk</a></p><br>
        	               ...
        	               '.$Delivery_Address.'</p>
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    ($loginid, $name,$id)
        	                    {
        	                        ...
        	                        $message->from('muhammadnoman0786@hotmail.com','ouction');
            ...
            $status=$Orders->p_status;
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    ($loginid, $name,$id)
        	                    {
        	                        ...
        	                        $message->from('ouction@.pk','Ouction');
        	               ...
        	               '.$Delivery_Address.'</p>
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    ($loginid, $name,$id)
        	                    {
        	                        ...
        	                        $message->from('muhammadnoman0786@hotmail.com','Gainaloe');
